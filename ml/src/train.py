...
from src.nn import Transformer, ResNet
from src.evaluation import evaluate, evaluate_rocs, evaluate_confusion_matrices, evaluate_significance, evaluate_feature_importance
from src.training import find_lr, train, load_checkpoint
...
for config in instance_configs:
    ...
    # Select classes
    trn = trn.select_classes(config["classes"])
    val = val.select_classes(config["classes"])
    tst = tst.select_classes(config["classes"])

    # Select features
    allowed_features = config["features"]
