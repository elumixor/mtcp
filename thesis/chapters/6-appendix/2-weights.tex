...
% \subsection*{XXX\_VV\_NJET}

% \textbf{Channel Numbers for which a particular formula is applied:}
\begin{align}
    \text{Channels} = \{
...
% \textbf{Weighting Based on Number of Jets:}
\begin{equation}
...
% \textbf{Final Formula for XXX\_VV\_NJET:}
\begin{equation}
...
% \subsection*{XXX\_MC\_WEIGHT}

% \textbf{Year-based Weight:}
\begin{equation}
...
% \begin{align*}
%      & \text{custTrigSF\_LooseID\_FCLooseIso\_SLTorDLT} \\
%      & \text{weight\_pileup}                            \\
%      & \text{jvtSF\_customOR}                           \\
%      & \text{bTagSF\_weight\_DL1r\_85}                  \\
%      & XXX_{VV\_NJET}                                   \\
%      & \text{weight\_mc}                                \\
%      & \text{xs}                                        \\
%      & \text{lep\_SF\_CombinedTight\_0}                 \\
%      & \text{lep\_SF\_CombinedTight\_1}                 \\
%      & \text{lepSF\_PLIV\_Prompt\_0}                    \\
%      & \text{lepSF\_PLIV\_Prompt\_1}
% \end{align*}

% \textbf{Final Formula for XXX\_MC\_WEIGHT:}
\begin{align}
    \text{Event weight} = w =
