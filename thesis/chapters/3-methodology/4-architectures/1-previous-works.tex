...
Last results from \severin achieve \todo{XXX} accuracy, \todo{XXX} $\AUC_\tth$ and \todo{XXX}
significance. \jan results are \todo{XXX} accuracy, \todo{XXX} $\AUC_\tth$ and \todo{XXX}.
...
% Do we need to include this? Is it even true? I didn't understand how we can select features during sys uncertainty
% estimation...
